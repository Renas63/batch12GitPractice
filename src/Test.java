public class Test {
    public static void main(String[] args) {
        ...
        System.out.println("toni practice");
        String str1 = "Successfully completed java and Started Selenium";
        ...
        System.out.println("Ainur is trying #100");
        System.out.println("lets see what is gonna happen #100");
